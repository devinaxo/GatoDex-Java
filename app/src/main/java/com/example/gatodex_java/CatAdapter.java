...
public class CatAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        Glide.with(context)
                .load(imagePath)
                .placeholder(R.drawable.default_cat_image) // Placeholder until the image is loaded
                .error(R.drawable.default_cat_image)       // Error placeholder if the image fails to load, for some reason if I delete this line it doesn't load the image
                .into(catImageView);
